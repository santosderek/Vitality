...
def test_initalization():
    ...
    assert trainee.lng == 0
    assert trainee.lat == 0
...
def test_repr():
    ...
    assert repr(trainee) \
        == "Trainee(000000000000000000000001, trainee, newPassword, test trainee, 1234567890, big, fat, 7, 100, 12345, 95, notfat, 0, 0, [\'000000000000000000000002\'])"
