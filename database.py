...
class Database():
    ...
    def get_username(self, id, username):
        return self.mongo.db.user.find({"id": id, "username": username})
    ...
    def get_password(self, id, password):
        return self.mongo.db.user.find({"id": id, "password": password})
    ...
    def get_location(self, id, location):
        return self.mongo.db.user.find({"id": id, "location": location})
    ...
    def get_phone(self, id, phone):
        return self.mongo.db.user.find({"id": id, "phone": phone})
